...
# PATH_MAIN = 'ams/ams_weekly/AnaphaseTreatmentBrowse.do'
...
class Background:
    ...
    def log(self, project_key, project_name, content, start='', end='', over_start='', over_end=''):
        ...
        response = self.session.post('{}/{}'.format(URL_ROOT, PATH_LOG), data=data, headers={
            ...
            'Referer': 'http://106.37.227.19:7003/ams/ams_weekly/WeeklyweeklyAdd.do',
            'Host': '106.37.227.19'
    ...
    def demo(self):
        ...
        self.log(project_key=project[0]['key'], project_name=project[0]['name'],
                 ...
                 start="2018-10-28 15:00", end="2018-10-28 18:00")
        for detail in self.query(username='许文哲', begin='2018-10-28', end='2018-10-30'):
            print(detail)
        pass
